...
export function HomeScenes() {
  return <>
    ...
    <section className="detail-scene"><div className="detail-image" aria-hidden="true"><div className="detail-watch"><Image src="/media/hero-watch.png" alt="" fill sizes="(max-width: 900px) 100vw, 63vw" /></div></div><div className="detail-copy"><p className="section-kicker">O olhar do curador</p><h2>O detalhe muda tudo.</h2><p>Material, proporção e presença são observados antes de qualquer narrativa. Informação clara ocupa o mesmo espaço que o desejo.</p><div className="detail-lines"><span>01 · Contexto</span><span>02 · Clareza</span><span>03 · Discrição</span></div></div></section>
